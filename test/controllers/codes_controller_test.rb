...
class CodesControllerTest < ActionController::TestCase
  ...
  test "should create code" do
    assert_difference('Code.count') do
      post :create, code: { cases: @code.cases, language: @code.language, source: @code.source, uid: @code.uid }
    end
  ...
  test "should update code" do
    patch :update, id: @code, code: { cases: @code.cases, language: @code.language, source: @code.source, uid: @code.uid }
    assert_redirected_to code_path(assigns(:code))
  end
